 ...
 * 
 * Output is received in binary, in frames as specified by the datapoint struct.
...
#ifdef _WIN32
            fprintf(stderr, "Example: %s 50000000 900000000 20 5 2 COM3 COM4\n\n", argv[0]);
#else
...
#ifdef _WIN32
        fprintf(stderr, "Warning: No ports specified, will use hardcoded COM3\n");
#else
